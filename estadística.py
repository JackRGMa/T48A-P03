...
# Media por filas
mean_rows = np.mean(datos_mexico, axis=1)
print(f"Media por filas: {mean_rows}")

# Desviación estandar por columnas
std_cols = np.std(datos_mexico, axis=0)
print(f"Desviación estándar por columnas: {std_cols}")

# Varianza por filas
var_rows = np.var(datos_mexico, axis=1)
print(f"Varianza por filas: {var_rows}")
...
# Percentiles por filas (percentil 50 = mediana)
percentile_50_rows = np.percentile(datos_mexico, 50, axis=1)
print(f"Percentil 50 (mediana) por filas: {percentile_50_rows}")
